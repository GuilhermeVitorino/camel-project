...
public class OrdersRoute {
    ...
    public static final String REST_ENDPOINT = "localhost:8080/webservices/ebook/item";
    public static final String SOAP_ENDPOINT = "localhost:8080/webservices/financial";
